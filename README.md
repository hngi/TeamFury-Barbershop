...
* Clone the repository.
   ...
   ```
    git clone https://github.com/hngi/Team-Fury-Barbershop.git
   ```
    
* Make the original HNGi/TalentPool repo the remote upstream (at upstream)
```
git remote add upstream https://github.com/hngi/Team-Fury-Barbershop.git
```
* Create a branch from master, ALWAYS CREATE YOUR BRANCH FROM DEVELOP,
...
```
Consistently pull from the master branch to avoid not getting your pull request merged and to avoid conflicts.
